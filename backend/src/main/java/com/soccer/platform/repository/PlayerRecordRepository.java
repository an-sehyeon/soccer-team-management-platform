...
public interface PlayerRecordRepository extends JpaRepository<PlayerRecordEntity, Integer> {
    ...
    // 같은 경기 영상과 같은 선수의 활성 기록 단건 조회
    // 기록 이벤트 등록 시 기존 player_record가 있으면 재사용하기 위해 사용
    Optional<PlayerRecordEntity> findFirstByGameVideoUploadAndPlayerAndIsDeletedFalse(
