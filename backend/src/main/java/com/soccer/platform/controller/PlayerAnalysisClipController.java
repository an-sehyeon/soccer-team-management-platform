...
public class PlayerAnalysisClipController {
    ...
    public ResponseEntity<PlayerAnalysisClipPageResponseDTO> findPlayerAnalysisClipsForManagement(
        ...
        PlayerAnalysisClipPageResponseDTO response =
                playerAnalysisClipService.findPlayerAnalysisClipsForManagement(
                        matchVideoId,
                        playerId,
                        clipType,
                        pageable,
    ...
    public ResponseEntity<PlayerAnalysisClipDetailResponseDTO> findPlayerAnalysisClipDetailForManagement(
        ...
        PlayerAnalysisClipDetailResponseDTO response =
                playerAnalysisClipService.findPlayerAnalysisClipDetailForManagement(
                        playerClipId,
                        principal
                );
    ...
    public ResponseEntity<CreatePlayerAnalysisClipResponseDTO> createPlayerAnalysisClip(
        ...
        CreatePlayerAnalysisClipResponseDTO response =
                playerAnalysisClipService.createPlayerAnalysisClip(request, principal);
    ...
    public ResponseEntity<PlayerAnalysisClipDetailResponseDTO> updatePlayerAnalysisClip(
        ...
        PlayerAnalysisClipDetailResponseDTO response =
                playerAnalysisClipService.updatePlayerAnalysisClip(
                        playerClipId,
                        request,
                        principal
                );
    ...
    public ResponseEntity<PlayerAnalysisClipPageResponseDTO> findMyPlayerAnalysisClips(
        ...
        PlayerAnalysisClipPageResponseDTO response =
                playerAnalysisClipService.findMyPlayerAnalysisClips(
                        matchVideoId,
                        clipType,
                        pageable,
                        principal
    ...
    public ResponseEntity<PlayerAnalysisClipDetailResponseDTO> findMyPlayerAnalysisClipDetail(
        ...
        PlayerAnalysisClipDetailResponseDTO response =
                playerAnalysisClipService.findMyPlayerAnalysisClipDetail(
                        playerClipId,
                        principal
                );
