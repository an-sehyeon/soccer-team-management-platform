// 팀 분석 클립 영상 위에 드로잉 데이터를 캔버스로 표시하고 새 드로잉 좌표를 생성하는 컴포넌트
...
type TeamAnalysisDrawingCanvasProps = {
  drawings: TeamAnalysisClipDrawingResponse[];
  currentTimeSec: number;
  isDrawingMode: boolean;
  drawingType: TeamAnalysisClipDrawingType;
  drawingText: string;
  onDraftDrawingData: (drawingData: TeamAnalysisClipDrawingData) => void;
};
...
export default function TeamAnalysisDrawingCanvas({
  drawings,
  currentTimeSec,
  isDrawingMode,
  drawingType,
  drawingText,
  onDraftDrawingData,
}: TeamAnalysisDrawingCanvasProps) {
