...
## 21. 다음 백엔드 작업 시작 시 필요한 파일

다음 작업은 선수 기록 관리 프론트 연동이다.
...
CreatePlayerRecordRequestDTO.java
CreatePlayerRecordResponseDTO.java
PlayerRecordDetailResponseDTO.java
PlayerRecordListResponseDTO.java
PlayerRecordPageResponseDTO.java
ErrorCode.java
SecurityConfig.java
```
